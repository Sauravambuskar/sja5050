...
const fetchCounts = async () => {
  ...
  const { data: investmentWithdrawalsData, error: investmentWithdrawalsError } = await supabase.rpc('get_all_investment_withdrawal_requests_count', { p_status_filter: 'Pending', p_search_text: null });
