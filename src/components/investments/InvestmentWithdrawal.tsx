...
import { HandCoins, History, Info, Loader2 } from "lucide-react";
...
export const InvestmentWithdrawal = () => {
  ...
  const { user } = supabase.auth.getUser() as any;
          ...
          <Table>
            ...
            <TableBody>
              {isLoadingInvestments ? (
                <TableRow><TableCell colSpan={2} className="text-center">Loading investments...</TableCell></TableRow>
