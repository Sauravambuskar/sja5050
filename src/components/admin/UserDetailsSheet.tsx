    ...
    return (
      <div className="space-y-6">
        ...
        <Tabs defaultValue="profile">
          <TabsList className="grid w-full grid-cols-5"><TabsTrigger value="profile">Profile</TabsTrigger><TabsTrigger value="transactions">Transactions</TabsTrigger><TabsTrigger value="investments">Investments</TabsTrigger><TabsTrigger value="referrals">Referrals</TabsTrigger><TabsTrigger value="adjust">Adjust Wallet</TabsTrigger></TabsList>
          ...
          <TabsContent value="referrals" className="mt-4"><Card><CardHeader><CardTitle>User's Referral Network</CardTitle><CardDescription>A tree view of this user's multi-level referral network.</CardDescription></CardHeader><CardContent><AdminReferralTree userId={user.id} /></CardContent></Card></TabsContent>
