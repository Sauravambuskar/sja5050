...
export const NomineeManager = ({ userId, nomineeOcrFill, onNomineeOcrFillApplied }: NomineeManagerProps) => {
  ...
  useEffect(() => {
    ...
    toast.info('Nominee details pre-filled from document. Select relationship and save.');
