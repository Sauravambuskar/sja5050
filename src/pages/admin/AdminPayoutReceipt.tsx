...
const AdminPayoutReceipt = () => {
  ...
  const handleDownloadPdf = () => {
    ...
    const body: (string | number)[][] = [
      ...
      ["User Name", receipt.user_name || "N/A"],
      ["User Email", receipt.user_email || "N/A"],
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Payout Receipt (Admin)</h1>
        <p className="text-muted-foreground">Detailed payout receipt for reference and records.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Receipt</CardTitle>
          <CardDescription>View, verify, and download payout receipt.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
...
export default AdminPayoutReceipt;