CREATE OR REPLACE FUNCTION public.get_all_deposit_requests(p_status_filter text DEFAULT NULL, p_search_text text DEFAULT NULL, p_limit integer DEFAULT 10, p_offset integer DEFAULT 0)
