...
BEGIN
    ...
    SELECT
        ...
        wr.requested_at,
        wr.status,
        -- Construct details JSONB object carefully
        jsonb_build_object(
            ...
            'reason', wr.details->>'reason', -- Always include reason if present
            'investment_id', wr.details->>'investment_id', -- Always include investment_id if present
            'plan_name', CASE
...
RETURNS TABLE(total_users bigint, aum numeric, pending_kyc bigint, pending_withdrawals_count bigint, pending_deposits_count bigint, pending_deposits_value numeric, pending_investments_count bigint, pending_investments_value numeric, monthly_payout_projection numeric)
