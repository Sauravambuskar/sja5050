-- Drop the old function to change its return signature
DROP FUNCTION IF EXISTS public.get_admin_dashboard_stats();

-- Recreate the function with the new fields for investment withdrawals
...
RETURNS TABLE(
    ...
    pending_withdrawals_value numeric,
    ...
    pending_investment_withdrawals_count bigint,
    pending_investment_withdrawals_value numeric,
