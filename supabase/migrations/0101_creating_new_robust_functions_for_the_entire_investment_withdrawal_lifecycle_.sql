-- Function for users to request a partial or full withdrawal
...
-- Function for admins to get all requests (with search and pagination)
...
-- Function for admins to count all requests
...
-- Function for admins to process (approve/reject) requests
