...
-- Recreate the function to get all deposit requests for admin view
...
-- Recreate the function to count all deposit requests for admin view
...
-- Recreate the function for admin to process a deposit request
