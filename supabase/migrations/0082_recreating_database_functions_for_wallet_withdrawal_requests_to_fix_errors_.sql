-- Function to get paginated and filtered withdrawal requests
CREATE OR REPLACE FUNCTION public.get_all_withdrawal_requests(p_status_filter text DEFAULT NULL::text, p_search_text text DEFAULT NULL::text, p_limit integer DEFAULT 10, p_offset integer DEFAULT 0)
...
-- Function to count withdrawal requests
